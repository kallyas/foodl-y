...
data class ImageSliderSliderbgFiveModel(
  /**
   * TODO Replace with dynamic value
   */
  var txtTheHalalGuysFive: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_cafe_brichor_s)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtNineteen: String? = MyApp.getInstance().resources.getString(R.string.lbl)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtTimeFive: String? = MyApp.getInstance().resources.getString(R.string.lbl_25_min2)
  ,
  /**
   * TODO Replace with dynamic value
   */
