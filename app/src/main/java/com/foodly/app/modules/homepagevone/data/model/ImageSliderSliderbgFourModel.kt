...
data class ImageSliderSliderbgFourModel(
  /**
   * TODO Replace with dynamic value
   */
  var txtTheHalalGuysFour: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_mcdonald_s)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtEighteen: String? = MyApp.getInstance().resources.getString(R.string.lbl)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtTimeFour: String? = MyApp.getInstance().resources.getString(R.string.lbl_25_min2)
  ,
  /**
   * TODO Replace with dynamic value
   */
