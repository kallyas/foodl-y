...
class SpinnerDeliveryaddresAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerDeliveryaddresModel>
) : ArrayAdapter<SpinnerDeliveryaddresModel>(mContext, layoutResource, allItems) {
